...
public sealed class ConcatTests
{
	...
	{
		ObservableList<int> firstSource = [1, 2, 3];
		ObservableList<int> secondSource = [4, 5, 6];
	...
	private static void ValidateSecondSourceItemsOffset(RecordingObserver<IndexedChange<int>> observer, ObservableList<int> firstSource)
	{
